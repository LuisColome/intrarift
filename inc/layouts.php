...
/**
 * Add post type to support the different post types styles.
 * 
 * @param array $classes 
 * @return array The custom classes.
 */
function lcm_some_body_class( $classes ) {
    
    if ( is_singular( array ('post','parques','lugares','etnias') )  )
    $classes[] = 'post-type-' . get_post_type();
    return $classes;
}
add_filter( 'body_class', 'lcm_some_body_class' );